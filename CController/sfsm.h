...
#define SFSM_BEGIN_EVENTS_DECL \
	enum SFSM_States_t {
		
#define SFSM_END_EVENTS_DECL \
	} _sfsm__next_state_;

#define SFSM_DECL_EVENT(event) \
	SFSM_STATE__##event,
...
#define SFSM_BEGIN_EVENT_HANDLER(state) \
	case SFSM_STATE__##state: {

#define SFSM_END_EVENT_HANDLER \
	} break;
